...
brew install go antigen tmux thefuck nvm gh git-flow git-lfs helm neovim ruby terraform tree wget kubernetes-cli act ngrok fastlane cocoapods exa alt-tab vagrant appium
